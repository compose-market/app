        ...
        <Sheet open={open} onOpenChange={onOpenChange}>
            ...
            >
                <SheetHeader className="pb-4">
                    <div className="flex items-center justify-between">
                        <SheetTitle className="font-display text-lg text-cyan-400">
                            Execution Results
                        </SheetTitle>
                        <Button
                            variant="ghost"
                ...
                {result.output?.multimodal && (
                    <div className="mb-4 p-4 rounded-md bg-gradient-to-b from-cyan-500/10 to-transparent border border-cyan-500/30">
                        <div className="flex items-center gap-2 mb-3">
                            {result.output.multimodal.outputType === "image" && <ImageIcon className="w-4 h-4 text-cyan-400" />}
                            {result.output.multimodal.outputType === "audio" && <Music className="w-4 h-4 text-cyan-400" />}
                            {result.output.multimodal.outputType === "video" && <Video className="w-4 h-4 text-cyan-400" />}
                            <span className="font-mono text-sm font-medium text-cyan-400">Final Output</span>
