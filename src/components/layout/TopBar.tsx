...
export function TopBar() {
  ...
  return (
    <header className="h-16 border-b border-sidebar-border bg-background/80 backdrop-blur-md fixed top-0 right-0 left-0 md:left-64 z-40 flex items-center justify-between px-4 md:px-6 gap-4">
